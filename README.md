...
￼
Caption:
Figure 1: Wazuh agent overview showing the Ubuntu server actively reporting to the Wazuh manager.
...
￼
Caption: Figure 2: Individual SSH authentication failure events generated after failed login attempts.

PAM Authentication Failures
￼
Caption: Figure 3: PAM authentication failure events recorded on the Ubuntu server.

Correlation Rule Triggered
￼
Caption: Figure 4: Correlation alert triggered after multiple failed SSH attempts.
...
￼
Caption: Figure 5: Detailed event view showing source IP, targeted user, and log source.
